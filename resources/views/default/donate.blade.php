 ...
 <div class="col-md-4">
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<img class="img-responsive img-rounded" style="display: inline-block;" src="{{url('campaigns/small',$response->small_image)}}" />
			</div>
		</div>	
	...
	@if( $settings->payment_gateway == 'Paypal' )	
		<div class="panel panel-default">
		<div class="panel-body">
			<img class="img-responsive img-rounded" style="display: inline-block;" src="{{url('img/payment-1.png')}}" />
			</div>
		</div>
		@endif
	    ...
	    <div class="media none-overflow">
	    	...
	    	<span class="btn-block text-center margin-bottom-10 text-muted"><strong>{{trans('misc.organizer')}}</strong></span>
			  ...
			  <div class="media-center margin-bottom-5">
			      <img class="img-circle center-block" src="{{url('avatar/',$response->user()->avatar)}}" width="60" height="60" >
			  </div>
