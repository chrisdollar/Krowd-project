...
class HomeController extends Controller
{
	...
	public function category($slug) {
		...
		$settings = AdminSettings::first();
		 ...
		 $category = CampaignCategory::where('slug','=',$slug)->first();
	  	 $data     = Campaigns::where('status', 'active')->where('category_id',$category->id)->orderBy('id','DESC')->paginate($settings->result_request);
